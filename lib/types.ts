...
export type ProvenanceSource =
  // New, site-neutral values — primary going forward.
  | "listing"              // read directly from whatever listing page the user is on
  | "inferred"             // sane default we filled in when the page didn't say
  | "verified"             // cross-checked against an external data source
  | "user"                 // user has overridden this value
  // Legacy values — still emitted by older pipeline paths, will be retired.
  | "zillow-listing"
  | "rentcast"
  | "rent-comps"
  | "fred"
